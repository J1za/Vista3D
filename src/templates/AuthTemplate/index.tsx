        ...
        <ModalMUI>
            <Box component='div'>
                <Typography variant="h4" component="div" className='ffHelvetica' textAlign='center' fontWeight={700}>
                    <Typography component='h4' sx={{ fontSize: { sm: 32, xs: 24 }, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 1 }} className='ffHelvetica' fontWeight={700}>Congratulations! <img src={SuccesIcon.src} /> </Typography>
